...
generated-by: github-copilot / adr-writer-madr / claude-opus-4-5  # agent-name / skill-name / model-id
...
<!-- generated-by: github-copilot / adr-writer-madr / claude-opus-4-5 -->
```

## Data Provenance

Every ADR generated by this agent **must** include the agent name and model ID. This is a requirement of trustworthy AI, digital ethics, and data provenance: anyone reading the ADR should know whether a human drafted it or an AI agent, and which model was responsible for the generated content.

**RACI mapping for AI-assisted ADRs**:
- **Accountable**: the human who reviews, accepts, and saves the ADR — always a person
- **Responsible (draft)**: this agent (`adr-writer-madr`) using the identified model
- **Consulted / Informed**: unchanged from standard team RACI
